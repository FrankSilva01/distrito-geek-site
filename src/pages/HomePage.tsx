...
export function HomePage() {
  ...
  const editorialCategoryPath = (slug: string) => slug === 'action-figures' ? '/action-figures' : slug === 'miniaturas-rpg' ? '/miniaturas-rpg' : '/kits-rpg'
  return <>
