...
export type AnalyticsEventName = 'view_category' | 'search_product' | 'filter_catalog' | 'click_mercado_livre' | 'click_shopee' | 'click_tiktok_shop' | 'click_whatsapp_product'
...
const ALLOWED_KEYS = new Set(['event', 'product_id', 'product_slug', 'external_id', 'product_name', 'category', 'price', 'marketplace', 'marketplace_url', 'search_term', 'filter_type', 'filter_value', 'result_count', 'zero_results', 'list_name', 'position', 'guide_slug', 'guide_title', 'guide_cluster', 'destination_slug'])
