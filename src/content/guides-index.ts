...
export const GUIDE_INDEX: GuideSummary[] = [
  ...
  { slug: "criar-encontros-rpg", cluster: "mestre", title: "Como criar encontros de RPG mais divertidos", seoTitle: "Como Criar Encontros de RPG Mais Divertidos", seoDescription: "Encontro não é só combate. Veja como usar objetivo, ambiente e consequência para montar cenas que o grupo vai lembrar, com exemplos prontos para usar.", updatedAt: "2026-08-09", readingMinutes: 10, productKeywords: ["goblin", "kit", "cenario"] },
