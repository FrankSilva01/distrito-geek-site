...
export const GUIDE_INDEX: GuideSummary[] = [
  ...
  { slug: "demonios-rpg", cluster: "criaturas", title: "Demônios no RPG: como usar na campanha e nos encontros", seoTitle: "Demônios no RPG: Encontros, Cultos e Criaturas Demoníacas", seoDescription: "Demônios rendem como tropa, elite e chefe numa campanha de fantasia. Veja como usar cultos, portais e encontros demoníacos sem virar combate genérico.", updatedAt: "2026-08-30", readingMinutes: 9, productKeywords: ["demônio", "demoníaca"] },
